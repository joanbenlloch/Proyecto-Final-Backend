...
const sameUser = require("../middleware/same")
 ...
 *          - bearerAuth: []
 */
router.put("/update/:id", authMiddleware, sameUser, validatorGetUser, validatorUpdate, updateUser)
 ...
 *          - bearerAuth: []
 */
router.delete("/users/:id", authMiddleware, sameUser, validatorGetUser, deleteUser)
